...
-- 导出 west-shard-demo 的数据库结构
CREATE DATABASE IF NOT EXISTS `west-shard-demo` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `west-shard-demo`;

-- 导出  表 west-shard-demo.activity_0 结构
...
-- 数据导出被取消选择。
-- 导出  表 west-shard-demo.activity_1 结构
